...
为 OpenHarmony 平台准备的包管理器（ohloha）的包迁移仓库，存放着各种系统依赖库的编译构建和安装时补丁的流程。

本仓库提供了从源码级别的成体系的迁移方案，您可以在此基础上很轻松的迁移其他需要的库。

> [!NOTE]
>
> 本项目已加入 OpenHarmony Robot PMC 孵化。镜像仓参见[这里](https://gitcode.com/openharmony-robot/tools_ohloha_pkgs)。
